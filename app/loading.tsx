...
function LoadingSideBar() {
  ...
  return (
    <div className="fixed left-0 top-0 bg-cyan-900 text-white w-64 min-h-screen p-6 z-10">
      <div className="mb-8">
        ...
        {navigation.map((item, key) => {
          ...
          return (
            <Link
              href={item.href}
              key={item.name}
              className="flex items-center space-x-3 py-3 px-3 rounded-lg transition-colors hover:bg-cyan-700 text-gray-300"
            >
